...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private bool CheckDuplicate(string inid, long iusercode)
        {
            try
            {
                using (OleDbConnection conn = new OleDbConnection(connectionString))
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("@NationalCode", inid);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string txtNationalCode = textBox3.Text.Trim();
            ...
            string nationalCode = txtNationalCode.Trim();
            if (nationalCode.Length != 10) // یا هر شرطی که بخوای
            {
