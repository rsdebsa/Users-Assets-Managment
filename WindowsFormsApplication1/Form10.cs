...
namespace WindowsFormsApplication1
{
    public partial class Form10 : Form
    {
        ...
        private void SetupDataGridView()
        {
            ...
            //dgvData.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "ID", Name = "ID", HeaderText = "کد تراکنش", Visible = false });
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            try
            {
                string reportPath = Path.Combine(Application.StartupPath, "Reports", "UsersOnly.mrt");
